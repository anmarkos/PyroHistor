...
var case_study = 'Bolivia_2019';      var prevYear = 2018;  var start = ee.Date('2019-08-16').advance(timeDiff,'hour');   var end =   ee.Date('2019-10-03').advance(timeDiff,'hour');  
var AOI = ee.Geometry.Polygon([-60.38825642476403,-18.06608159280984,-60.60940401236942,-17.9770144530835,-60.74123994986942,-18.339775694865303,-60.29133638724863,-18.63018750804589,-60.2939531890978,-18.753727166246268,-59.98506916119312,-19.000430394367594,-59.66733141014745,-19.42055744690413,-59.447913333464896,-19.5860492632623,-59.27195023053722,-19.610943760338063,-59.13998262565067,-19.912267056597948,-58.73898164908817,-19.92776056707508,-58.76644746940067,-19.340540111469004,-58.94329785902364,-19.140532025936402,-59.23988009934464,-18.98337206086423,-59.59360551546936,-18.652386273310043,-59.67928652943162,-18.55964760796376,-59.76049617195985,-18.359553629167635,-59.8854429680149,-18.211535750797363,-59.95846407096317,-17.94566173130038,-60.38825642476403,-18.06608159280984])
...
var maxDistance = 4
var numPoints = 100
var lookBack = 120   //  to save memory when exporting set this paraemter to 120
...
Map.addLayer(minutes_elapsed, {min:0,max:67130,palette:palette_Progress}, 'Minutes Elapsed');
...
// // ////////   LEGEND ////////////
var vis = {min: '0', max: '67130', palette: palette_Progress};
